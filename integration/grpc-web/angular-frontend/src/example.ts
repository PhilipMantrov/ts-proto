...
const baseCommonResponse: object = {
  success: false,
};
...
export interface DashState {
  ...
  SendUserSetting(request: DeepPartial<DashUserSettingsState>, metadata?: grpc.Metadata): Observable<CommonResponse>;
...
export class DashStateClientImpl implements DashState {
  ...
  SendUserSetting(request: DeepPartial<DashUserSettingsState>, metadata?: grpc.Metadata): Observable<CommonResponse> {
    return this.rpc.unary(DashStateSendUserSettingDesc, DashUserSettingsState.fromPartial(request), metadata);
  }
...
export const CommonResponse = {
  encode(message: CommonResponse, writer: Writer = Writer.create()): Writer {
    writer.uint32(8).bool(message.success);
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): CommonResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseCommonResponse } as CommonResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<CommonResponse>): CommonResponse {
    const message = { ...baseCommonResponse } as CommonResponse;
    if (object.success !== undefined && object.success !== null) {
...
export const DashUserSettingsState = {
  encode(message: DashUserSettingsState, writer: Writer = Writer.create()): Writer {
    ...
    writer.uint32(16).int64(message.longNumber);
    writer.uint32(24).int32(message.smallNumber);
    if (message.urls !== undefined && message.urls !== undefined) {
      DashUserSettingsState_URLs.encode(message.urls, writer.uint32(34).fork()).ldelim();
    }
    for (const v of message.flashes) {
      DashFlash.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.longNumber = longToNumber(reader.int64() as Long);
          break;
        case 3:
          message.smallNumber = reader.int32();
          break;
        case 4:
  ...
  fromJSON(object: any): DashUserSettingsState {
    ...
    if (object.longNumber !== undefined && object.longNumber !== null) {
      message.longNumber = Number(object.longNumber);
    } else {
      message.longNumber = 0;
    }
    if (object.smallNumber !== undefined && object.smallNumber !== null) {
      message.smallNumber = Number(object.smallNumber);
    } else {
      message.smallNumber = 0;
    }
  ...
  fromPartial(object: DeepPartial<DashUserSettingsState>): DashUserSettingsState {
    ...
    if (object.smallNumber !== undefined && object.smallNumber !== null) {
      message.smallNumber = object.smallNumber;
    } else {
      message.smallNumber = 0;
    }
    if (object.urls !== undefined && object.urls !== null) {
  ...
  toJSON(message: DashUserSettingsState): unknown {
    ...
    message.longNumber !== undefined && (obj.longNumber = message.longNumber);
    message.smallNumber !== undefined && (obj.smallNumber = message.smallNumber);
...
export const DashStateSendUserSettingDesc: UnaryMethodDefinitionish = {
  methodName: "SendUserSetting",
  service: DashStateDesc,
  requestStream: false,
  responseStream: false,
  requestType: {
  ...
  responseType: {
    deserializeBinary: function deserializeBinary(data: Uint8Array) {
      return { ...CommonResponse.decode(data), toObject() { return this; } };
    }
    ,
  } as any,
}
